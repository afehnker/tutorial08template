import pygame
import sys
from exercises.helpers.keyboard_handler import KeyboardHandler
from exercises.bubbles import Bubble, Bebble, Bobble, Box
...
class Game:
    ...
    def __init__(self):
        ...
        self.balls = [];
        for i in range(5):
            self.balls.append(Bubble(200, 200, (0, 0, 255)))
